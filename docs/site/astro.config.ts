...
export default defineConfig({
  ...
  redirects: {
    "/guides/claude": "/claude/configure",
    "/guides/claude-advanced": "/claude/advanced",
    "/guides/codex": "/codex/configure",
    ...
    "/ja/guides/claude": "/ja/claude/configure",
    "/ja/guides/claude-advanced": "/ja/claude/advanced",
    "/ja/guides/codex": "/ja/codex/configure",
    ...
    "/zh/guides/claude": "/zh/claude/configure",
    "/zh/guides/claude-advanced": "/zh/claude/advanced",
    "/zh/guides/codex": "/zh/codex/configure",
