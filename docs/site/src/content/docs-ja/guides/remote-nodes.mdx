...
初期版は任意の Shell 実行を提供しません。リモート Provider の作成・編集、API Key
転送、MCP/Skills、Session/Usage、バックアップ復元、更新インストール、Gateway
トンネルもまだ対象外です。Provider は先にリモート側で追加またはインポートし、
デスクトップからそれらを切り替えます。
...
- 操作側コンピューターに OcHub Desktop `0.4.20` 以降。
