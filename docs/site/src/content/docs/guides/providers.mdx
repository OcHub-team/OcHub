...
<OcHubAppFigure locale="en" screen="connections" />
...
<OcHubStepsVisual
  locale="en"
  labels="Open a connection|Edit its fields|Add it to the tool|Switch it live|Copy it to another app|Remove or delete carefully"
...
| App | Continue with |
| --- | --- |
| Claude Code / Claude Desktop | [Authentication, role models, MCP, and plugins](/claude) |
| Codex | [OAuth, Responses, reasoning, and session history](/codex) |
| Grok Build | [Profiles, API backends, and environment variables](/grok-build) |
| OpenCode | [AI SDK packages, provider IDs, and OMO](/opencode) |
| OpenClaw | [Protocols, default model, and tool permissions](/openclaw) |
| Hermes | [API modes, models, and memory](/hermes) |
