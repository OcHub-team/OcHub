...
<OcHubStepsVisual
  locale="en"
  labels="Open Settings|Open Apps and plugins|Toggle visible apps|Reload changed plugins"
  visuals="settings-nav|apps-settings|apps-settings|apps-settings"
/>
...
<OcHubStepsVisual
  locale="en"
  labels="Open Theme|Choose a display mode|Preview a theme card|Apply the theme"
  visuals="theme-nav|theme-mode|theme-card|theme-card"
/>
