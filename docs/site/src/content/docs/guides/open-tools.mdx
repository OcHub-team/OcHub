...
[Manage connections](/guides/providers). For configuration layers, credentials,
AI SDK protocol selection, and sharing, see
[Advanced OpenCode pitfalls](/guides/opencode-advanced). For effective config,
custom backends, permissions, sandboxing, and compatibility imports, see
[Advanced Grok Build pitfalls](/guides/grok-build-advanced).
