...
<OcHubStepsVisual
  locale="en"
  labels="Open Sessions|Filter by app and time|Open a conversation|Inspect long details|Refresh the list"
...
<OcHubStepsVisual
  locale="en"
  labels="Open Usage|Read the four totals|Choose a time range|Filter provider and model|Open one request|Verify tokens, cost, and latency"
