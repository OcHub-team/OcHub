...
| --- | --- | --- | --- | --- |
| Claude Code | [Configure Claude](/claude) | Current-connection switching | Yes | Yes |
| Claude Desktop | [Configure Claude](/claude) | Current-connection switching | No | No |
| Codex | [Configure Codex](/codex) | Current-connection switching | Yes | Yes |
| Grok Build | [Configure Grok Build](/grok-build) | Current-connection switching | Yes | No |
| OpenCode | [Configure OpenCode](/opencode) | Multiple connections coexist | Yes | Yes |
| OpenClaw | [Configure OpenClaw](/openclaw) | Multiple connections coexist | No | No |
| Hermes | [Configure Hermes](/hermes) | Multiple connections coexist | Yes | Yes |
