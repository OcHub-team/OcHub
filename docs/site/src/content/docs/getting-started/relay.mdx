...
description: Create a local relay upstream, switch a CLI onto it, and verify that requests pass through OcHub.
audience: human
sidebar:
  order: 2
---
...
6. **Switch a tool onto it.** Open the target app page (Codex, Claude Code, …)
   and select **Switch** on the station under **Relay mode**. Its live
...
Stations are switched from the app page as well:
