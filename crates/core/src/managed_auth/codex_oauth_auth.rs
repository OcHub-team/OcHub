//! Codex OAuth managed-account authentication.
//!
...
/// User-Agent
const CODEX_USER_AGENT: &str = "ochub-codex-oauth";
...
impl CodexOAuthManager {
    pub fn new(data_dir: PathBuf) -> Self {
        ...
        let manager = Self {
            ...
            // Reuse the process-wide HTTP connection pool for OAuth traffic.
            http_client: crate::http_client::get(),
            storage_path,
        };
