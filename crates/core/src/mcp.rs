...
//! `config.toml` mcp section, gemini settings, opencode, hermes).
//!
//! Submodules:
...
//! - `gemini` — Gemini MCP sync/import
//! - `opencode` — OpenCode MCP sync/import (local/remote format conversion)
//! - `hermes` — Hermes MCP sync/import (YAML format conversion)
//!
//! The top-level live-config writers (`claude_mcp`, `gemini_mcp`) live alongside
//! as submodules here too.
