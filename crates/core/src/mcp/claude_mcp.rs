//! Claude live MCP-config helpers (`~/.claude.json`).
//!
//! Ported from cc-switch `src-tauri/src/claude_mcp.rs`.
...
use crate::paths::{atomic_write, get_claude_mcp_path, get_default_claude_mcp_path};
