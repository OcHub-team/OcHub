...
impl Database {
    ...
    pub fn get_rectifier_config(
        &self,
    ) -> Result<crate::db::proxy_types::RectifierConfig, AppError> {
        match self.get_setting("rectifier_config")? {
            Some(json) => serde_json::from_str(&json)
                .map_err(|e| AppError::Database(format!("解析整流器配置失败: {e}"))),
            None => Ok(crate::db::proxy_types::RectifierConfig::default()),
        }
    }
    ...
    pub fn get_optimizer_config(
        &self,
    ) -> Result<crate::db::proxy_types::OptimizerConfig, AppError> {
        match self.get_setting("optimizer_config")? {
            Some(json) => serde_json::from_str(&json)
                .map_err(|e| AppError::Database(format!("解析优化器配置失败: {e}"))),
            None => Ok(crate::db::proxy_types::OptimizerConfig::default()),
        }
    }
    ...
    pub fn set_optimizer_config(
        &self,
        config: &crate::db::proxy_types::OptimizerConfig,
    ) -> Result<(), AppError> {
        let json = serde_json::to_string(config)
    ...
    pub fn get_copilot_optimizer_config(
        &self,
    ) -> Result<crate::db::proxy_types::CopilotOptimizerConfig, AppError> {
        match self.get_setting("copilot_optimizer_config")? {
            Some(json) => serde_json::from_str(&json)
                .map_err(|e| AppError::Database(format!("解析 Copilot 优化器配置失败: {e}"))),
            None => Ok(crate::db::proxy_types::CopilotOptimizerConfig::default()),
        }
    }
    ...
    pub fn set_copilot_optimizer_config(
        &self,
        config: &crate::db::proxy_types::CopilotOptimizerConfig,
    ) -> Result<(), AppError> {
        let json = serde_json::to_string(config)
    ...
    /// 获取日志配置
    pub fn get_log_config(&self) -> Result<crate::db::proxy_types::LogConfig, AppError> {
        match self.get_setting("log_config")? {
            Some(json) => serde_json::from_str(&json)
                .map_err(|e| AppError::Database(format!("解析日志配置失败: {e}"))),
            None => Ok(crate::db::proxy_types::LogConfig::default()),
        }
    }
    ...
    pub fn set_log_config(
        &self,
        config: &crate::db::proxy_types::LogConfig,
    ) -> Result<(), AppError> {
        let json = serde_json::to_string(config)
