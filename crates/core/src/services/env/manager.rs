//! Environment-variable deletion / backup / restore.
//!
//! Ported from cc-switch `services/env_manager.rs`. Backs up conflicting env
//! vars before deleting them, and can restore from a backup file.

use super::checker::EnvConflict;
use chrono::Utc;
...
fn get_backup_dir() -> Result<PathBuf, String> {
    Ok(crate::paths::get_app_config_dir().join("backups"))
}
...
/// Alias matching the public surface named in the port spec.
