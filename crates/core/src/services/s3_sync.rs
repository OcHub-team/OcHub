...
/// Example: `ochub-sync/v2/db-v6/default/manifest.json`
...
mod tests {
    ...
    fn test_settings() -> S3SyncSettings {
        S3SyncSettings {
            remote_root: "ochub-sync".to_string(),
    ...
    fn s3_key_uses_v2_and_correct_format() {
        ...
        assert_eq!(key, "ochub-sync/v2/db-v6/default/manifest.json");
    }
