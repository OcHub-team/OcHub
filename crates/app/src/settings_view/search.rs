...
pub(super) fn entry(row: RowId) -> &'static RowEntry {
    match row {
        ...
        RowId::WindowTrayResident => &RowEntry {
            id: "window-tray-resident",
            group: k::SETTINGS_STARTUP_TITLE,
            label: k::SETTINGS_BASIC_TRAY_RESIDENT_LABEL,
            desc: k::SETTINGS_BASIC_TRAY_RESIDENT_DESC,
            keywords: &[
                "tray",
                "dock",
                "taskbar",
        ...
        RowId::DataCcswitchImport => &RowEntry {
            id: "data-ccswitch-import",
            group: k::SETTINGS_DATA_TITLE,
            label: k::SETTINGS_DATA_CCSWITCH_LABEL,
            desc: k::SETTINGS_DATA_CCSWITCH_DESC,
            keywords: &[
                "cc-switch",
                "ccswitch",
                "import",
        ...
        RowId::SessionIndex => &RowEntry {
            id: "session-index",
            group: k::SETTINGS_DATA_TITLE,
            label: k::SETTINGS_SESSION_INDEX_LABEL,
            desc: k::SETTINGS_SESSION_INDEX_DESC,
            keywords: &[
                "search",
                "index",
                "fulltext",
        ...
        RowId::SessionIndexReclaim => &RowEntry {
            id: "session-index-reclaim",
            group: k::SETTINGS_DATA_TITLE,
            label: k::SETTINGS_SESSION_INDEX_RECLAIM_LABEL,
            desc: k::SETTINGS_SESSION_INDEX_RECLAIM_DESC,
            keywords: &[
                "reclaim", "vacuum", "space", "disk", "回收", "空间", "磁盘", "解放",
            ],
        },
        RowId::SessionIndexReclaimNow => &RowEntry {
            id: "session-index-reclaim-now",
            group: k::SETTINGS_DATA_TITLE,
            label: k::SETTINGS_SESSION_INDEX_RECLAIM_NOW_LABEL,
            desc: k::SETTINGS_SESSION_INDEX_RECLAIM_NOW_DESC,
            keywords: &["reclaim", "vacuum", "now", "回收", "立即", "今すぐ"],
        },
        RowId::SessionIndexDelete => &RowEntry {
            id: "session-index-delete",
            group: k::SETTINGS_DATA_TITLE,
            label: k::SETTINGS_SESSION_INDEX_DELETE_LABEL,
            desc: k::SETTINGS_SESSION_INDEX_DELETE_DESC,
            keywords: &["delete", "remove", "rebuild", "删除", "重建", "削除"],
        },
